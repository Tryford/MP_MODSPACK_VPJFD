...
INSERT INTO Specialists
		(Type,						Description,					Strategy,									GreatPeopleTitle,						GreatPeopleUnitClass, 	GreatPeopleRateChange, 	Visible,	SlotTexture,			IconAtlas,						PortraitIndex)
SELECT	'SPECIALIST_JFD_MONK',		'TXT_KEY_SPECIALIST_JFD_MONK',	'TXT_KEY_SPECIALIST_JFD_MONK_STRATEGY', 	'TXT_KEY_SPECIALIST_JFD_MONK_TITLE',	'UNITCLASS_PROPHET', 	3,						1,			'citizenMonk.dds',		'JFD_PIETY_SPECIALIST_ATLAS',	0

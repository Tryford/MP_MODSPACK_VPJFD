...
INSERT INTO GameSpeed_JFD_PietyThresholds
		(GameSpeedType,		MaxThreshold,	PietyYieldMod,	RestingRateMod) 
SELECT	Type,				100,			50,				0 -- 200, 0.75
FROM GameSpeeds WHERE Type IN ('GAMESPEED_EPIC', 'GAMESPEED_REPACE_EPIC')
AND EXISTS (SELECT * FROM JFD_GlobalUserSettings WHERE Type = 'JFD_RTP_PIETY_CORE' AND Value = 1);	

INSERT INTO GameSpeed_JFD_PietyThresholds
		(GameSpeedType,		MaxThreshold,	PietyYieldMod,	RestingRateMod) 
SELECT	Type,				100,			100,			0 -- 200, 0.75
FROM GameSpeeds WHERE Type IN ('GAMESPEED_MARATHON', 'GAMESPEED_REPACE_MARATHON')
AND EXISTS (SELECT * FROM JFD_GlobalUserSettings WHERE Type = 'JFD_RTP_PIETY_CORE' AND Value = 1);	
--==========================================================================================================================
-- PIETY LEVELS
--==========================================================================================================================
...
FROM GameSpeeds WHERE Type IN ('GAMESPEED_QUICK', 'GAMESPEED_REPACE_QUICK', 'GAMESPEED_STANDARD', 'GAMESPEED_REPACE_STANDARD', 'GAMESPEED_EPIC', 'GAMESPEED_REPACE_EPIC', 'GAMESPEED_MARATHON', 'GAMESPEED_REPACE_MARATHON')
AND EXISTS (SELECT * FROM JFD_GlobalUserSettings WHERE Type = 'JFD_RTP_PIETY_CORE' AND Value = 1);	
...
FROM GameSpeeds WHERE Type IN ('GAMESPEED_QUICK', 'GAMESPEED_REPACE_QUICK', 'GAMESPEED_STANDARD', 'GAMESPEED_EPIC', 'GAMESPEED_REPACE_EPIC', 'GAMESPEED_MARATHON', 'GAMESPEED_REPACE_MARATHON')
AND EXISTS (SELECT * FROM JFD_GlobalUserSettings WHERE Type = 'JFD_RTP_PIETY_CORE' AND Value = 1);
...
SELECT	'PIETY_LEVEL_JFD_DEVOUT',	PietyLevelType, MaxThreshold, MinThreshold
...
--------------------------------------------------------------------------------------------------------------------------	
INSERT INTO JFD_PietyLevel_CrimeMods
		(PietyLevelType,				 CrimeType,				CrimeMod)
SELECT	'PIETY_LEVEL_JFD_HERETICAL',	 'CRIME_JFD_FAITH',		100
WHERE EXISTS (SELECT * FROM JFD_GlobalUserSettings WHERE Type = 'JFD_RTP_PIETY_CORE' AND Value = 1);	

INSERT INTO JFD_PietyLevel_CrimeMods
		(PietyLevelType,				 CrimeType,				CrimeMod)
SELECT	'PIETY_LEVEL_JFD_POOR',			'CRIME_JFD_FAITH',		50
WHERE EXISTS (SELECT * FROM JFD_GlobalUserSettings WHERE Type = 'JFD_RTP_PIETY_CORE' AND Value = 1);	
--==========================================================================================================================
--==========================================================================================================================
...
UPDATE Buildings
SET PrereqTech = 'TECH_JFD_MEDICINE'
WHERE BuildingClass = 'BUILDINGCLASS_GARDEN' AND PrereqTech = 'TECH_PHILOSOPHY'
...
--Recycling Center
UPDATE Buildings
SET IsNoDiseaseFromBuildings = 1, Help = 'TXT_KEY_BUILDING_JFD_RECYCLING_CENTER_HELP', Strategy = 'TXT_KEY_BUILDING_JFD_RECYCLING_CENTER_STRATEGY'
...
WHERE BuildingClass = 'BUILDINGCLASS_STADIUM' AND PrereqTech = 'TECH_REFRIGERATION'
AND EXISTS (SELECT * FROM JFD_GlobalUserSettings WHERE Type = 'JFD_CID_HEALTH_CORE' AND Value = 1);

--JFDCID_Health_Buildings
CREATE TRIGGER JFDCID_Health_Buildings
AFTER INSERT ON Buildings
WHEN NEW.BuildingClass IN ('BUILDINGCLASS_AQUEDUCT', 'BUILDINGCLASS_GARDEN', 'BUILDINGCLASS_RECYCLING_CENTER')
AND EXISTS (SELECT * FROM JFD_GlobalUserSettings WHERE Type = 'JFD_CID_HEALTH_CORE' AND Value = 1)
BEGIN
	UPDATE Buildings
	SET River = 1
	...
	UPDATE Buildings
	SET IsNoDiseaseFromBuildings = 1
	WHERE BuildingClass = 'BUILDINGCLASS_RECYCLING_CENTER';
...
UPDATE Buildings
SET Cost = 300, GlobalPlotCultureCostModifier = 0, GlobalPlotBuyCostModifier = 0, Help = 'TXT_KEY_BUILDING_JFD_ANGKOR_WAT_HELP'
WHERE Type = 'BUILDING_ANGKOR_WAT'
AND EXISTS (SELECT * FROM JFD_GlobalUserSettings WHERE Type = 'JFD_CID_HEALTH_WONDER_CHANGES_ANGKOR_WAT' AND Value = 1);

--Great Mosque
UPDATE Buildings
SET PrereqTech = 'TECH_JFD_MEDICINE'
WHERE Type = 'BUILDING_MOSQUE_OF_DJENNE'
AND EXISTS (SELECT * FROM JFD_GlobalUserSettings WHERE Type = 'JFD_CID_HEALTH_WONDER_CHANGES_MOSQUE_DJENNE' AND Value = 1);
...
--Hanging Gardens
UPDATE Buildings
SET SpecialistType = 'SPECIALIST_JFD_DOCTOR', GreatPeopleRateChange = 1, Help = 'TXT_KEY_BUILDING_JFD_HANGING_GARDENS_HELP', FreeBuildingThisCity = 'BUILDINGCLASS_GARDEN'
...
--Temple of Artemis
UPDATE Buildings
SET SpecialistType = 'SPECIALIST_JFD_DOCTOR', GreatPeopleRateChange = 1
...
SELECT	'BUILDING_JFD_PONT_DU_GARD', 		20
WHERE EXISTS (SELECT * FROM JFD_GlobalUserSettings WHERE Type = 'JFD_CID_HEALTH_WONDER_ADDITIONS_PONT_DU_GARD' AND Value = 1);

INSERT INTO Building_JFD_HealthMods 
		(BuildingType, 						PlagueMod)
...
UPDATE Building_YieldChanges SET YieldType = 'YIELD_JFD_HEALTH' WHERE BuildingType = 'BUILDING_HOSPITAL' and YieldType = 'YIELD_FOOD'
AND EXISTS (SELECT * FROM JFD_GlobalUserSettings WHERE Type = 'JFD_CID_HEALTH_CORE' AND Value = 1);

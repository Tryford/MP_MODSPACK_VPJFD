...
local chooseGovernmentString = string.upper(Locale.ConvertTextKey( "TXT_KEY_CHOOSE_JFD_GOVERNMENT" ));
...
function OnEndTurnClicked()
	...
	--	end	
	elseif (userSettingRTPSovereignty and player:CanHaveAnyGovernment()) then

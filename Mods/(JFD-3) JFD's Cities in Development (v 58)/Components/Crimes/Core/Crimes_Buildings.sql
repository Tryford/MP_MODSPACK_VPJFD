...
CREATE TRIGGER JFDCID_Crimes_Building_Espionage
...
CREATE TRIGGER JFDCID_Crimes_Building_Defensive
AFTER INSERT ON Buildings 
...
BEGIN
	UPDATE Buildings
	SET GoldMaintenance = 1
	WHERE Type = NEW.Type AND BuildingClass IN ('BUILDINGCLASS_WALLS', 'BUILDINGCLASS_OBSERVATORY')
	AND EXISTS (SELECT * FROM JFD_GlobalUserSettings WHERE Type = 'JFD_CID_CRIMES_CORE' AND Value = 1);
	
	UPDATE Buildings
	SET GoldMaintenance = 2
	WHERE Type = NEW.Type AND BuildingClass IN ('BUILDINGCLASS_LIGHTHOUSE', 'BUILDINGCLASS_CASTLE', 'BUILDINGCLASS_ARSENAL', 'BUILDINGCLASS_EE_BASTION', 'BUILDINGCLASS_POLICE_STATION', 'BUILDINGCLASS_AQUEDUCT')
	AND EXISTS (SELECT * FROM JFD_GlobalUserSettings WHERE Type = 'JFD_CID_CRIMES_CORE' AND Value = 1);
	
	UPDATE Buildings
	SET GoldMaintenance = 3
	WHERE Type = NEW.Type AND BuildingClass IN ('BUILDING_MILITARY_BASE')
	AND EXISTS (SELECT * FROM JFD_GlobalUserSettings WHERE Type = 'JFD_CID_CRIMES_CORE' AND Value = 1);
END;
...
SELECT	Type,							'CRIME_JFD_DEFENSE',	-15
...
INSERT INTO Building_JFD_CrimeMods
		(BuildingType,					CrimeType,				CrimeMod)
SELECT	Type,							'CRIME_JFD_HEALTH',		-15
...
INSERT INTO Building_JFD_CrimeMods
		(BuildingType,					CrimeType,				CrimeMod)
SELECT	Type,							'CRIME_JFD_TOURISM',	-15
...
INSERT INTO Building_JFD_CrimeMods
		(BuildingType,					CrimeType,				CrimeMod)
SELECT	Type,							'CRIME_JFD_FAITH',		-15
...
INSERT INTO Building_JFD_CrimeMods
		(BuildingType,					CrimeType,				CrimeMod)
SELECT	Type,							'CRIME_JFD_SCIENCE',	-15
...
INSERT INTO Building_JFD_CrimeMods
		(BuildingType,					CrimeType,				CrimeMod)
SELECT	'BUILDING_BURIAL_TOMB',			'CRIME_JFD_CULTURE',	-15
WHERE EXISTS (SELECT * FROM JFD_GlobalUserSettings WHERE Type = 'JFD_CID_CRIMES_BUILDING_CHANGES_BURIAL_TOMB' AND Value = 1);

INSERT INTO Building_JFD_CrimeMods
		(BuildingType,					CrimeType,				CrimeMod)
SELECT	'BUILDING_JFD_JAIL',			'CRIME_JFD_FOOD',		-15
WHERE EXISTS (SELECT * FROM JFD_GlobalUserSettings WHERE Type = 'JFD_CID_CRIMES_CORE' AND Value = 1)
AND EXISTS (SELECT * FROM JFD_GlobalUserSettings WHERE Type = 'JFD_CID_CRIMES_BUILDING_CHANGES_NATIONAL_WONDERS' AND Value = 0);

INSERT INTO Building_JFD_CrimeMods
		(BuildingType,					CrimeType,				GlobalCrimeMod)

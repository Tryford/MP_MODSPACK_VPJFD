...
function UpdateDisplay()
	...
	local civDesc, civTT, leaderDesc, leaderTT = JFD_GetDiploListInfo(g_iPlayer)
	...
	for iPlayerLoop = 0, GameDefines.MAX_MAJOR_CIVS-1, 1 do
		...
		if (iPlayerLoop ~= g_iPlayer and pOtherPlayer:IsAlive()) then
			...
			if (g_pTeam:IsHasMet(iOtherTeam)) then
				...
				local civDesc, civTT, leaderDesc, leaderTT = JFD_GetDiploListInfo(iPlayerLoop)
...
if (not JFD_IsUsingCivIDDiplo()) then

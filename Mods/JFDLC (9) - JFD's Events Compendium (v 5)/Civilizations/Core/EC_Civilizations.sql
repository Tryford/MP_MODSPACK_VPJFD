...
VALUES	('CITY_EVENT_JFD_BHUTAN_MIGRANTS',									'TXT_KEY_CITY_EVENT_JFD_BHUTAN_MIGRANTS_DESCRIPTION',							'TXT_KEY_CITY_EVENT_JFD_BHUTAN_MIGRANTS_HELP',							'Event_BhutanMigrants.dds',		'AS2D_EVENT_JFD_GENERIC_EVENT',		2,			-1,				1,					50,				0,				0,			0,				0,							0,								NULL,								'ERA_RENAISSANCE'),
		...
		('CITY_EVENT_JFD_DESERET_WAGON_TRAINS',								'TXT_KEY_CITY_EVENT_JFD_DESERET_WAGON_TRAINS_DESCRIPTION',						'TXT_KEY_CITY_EVENT_JFD_DESERET_WAGON_TRAINS_HELP',						'Event_DeseretWagonTrains.dds',	'AS2D_EVENT_JFD_GENERIC_EVENT',		2,			-1,				1,					50,				0,				0,			0,				0,							0,								NULL,								'ERA_MEDIEVAL'),
		('CITY_EVENT_JFD_DESERET_ZION',										'TXT_KEY_CITY_EVENT_JFD_DESERET_ZION_DESCRIPTION',								'TXT_KEY_CITY_EVENT_JFD_DESERET_ZION_HELP',								'Event_DeseretZion.dds',		'AS2D_EVENT_JFD_GENERIC_EVENT',		2,			-1,				1,					50,				0,				0,			0,				0,							0,								NULL,								NULL),
...
VALUES	('CITY_EVENT_JFD_BHUTAN_MIGRANTS',									'CITY_EVENT_JFD_BHUTAN_MIGRANTS_CHOICE_1'),		
		...
		('CITY_EVENT_JFD_DESERET_WAGON_TRAINS',								'CITY_EVENT_JFD_DESERET_WAGON_TRAINS_CHOICE_1'),		
		('CITY_EVENT_JFD_DESERET_WAGON_TRAINS',								'CITY_EVENT_JFD_DESERET_WAGON_TRAINS_CHOICE_2'),
...
INSERT INTO CityEventChoices
		(Type,																EventChoiceAudio,				EventDuration,	EventChance,	EraScaling,		PietyYield,	CityHappiness,	RandomBarbarianSpawn,	WLTKDTurns,		Description,																		Help)
VALUES	('CITY_EVENT_JFD_BHUTAN_MIGRANTS_CHOICE_1',							'AS2D_EVENT_CHOICE',			30,				0,				1,				0,			0,				0,						0,				'TXT_KEY_CITY_EVENT_JFD_BHUTAN_MIGRANTS_DESCRIPTION_CHOICE_1',						'TXT_KEY_CITY_EVENT_JFD_BHUTAN_MIGRANTS_CHOICE_1_HELP'),
		('CITY_EVENT_JFD_BHUTAN_MIGRANTS_CHOICE_2',							'AS2D_EVENT_CHOICE',			30,				0,				0,				0,			0,				0,						15,				'TXT_KEY_CITY_EVENT_JFD_BHUTAN_MIGRANTS_DESCRIPTION_CHOICE_2',						'TXT_KEY_CITY_EVENT_JFD_BHUTAN_MIGRANTS_CHOICE_2_HELP'),
		('CITY_EVENT_JFD_BHUTAN_MONK_CHOICE_1',								'AS2D_EVENT_CHOICE',			30,				0,				0,				0,			0,				0,						0,				'TXT_KEY_CITY_EVENT_JFD_BHUTAN_MONK_DESCRIPTION_CHOICE_1',							'TXT_KEY_CITY_EVENT_JFD_BHUTAN_MONK_CHOICE_1_HELP'),
		('CITY_EVENT_JFD_BHUTAN_MONK_CHOICE_2',								'AS2D_EVENT_CHOICE',			30,				0,				1,				5,			0,				0,						0,				'TXT_KEY_CITY_EVENT_JFD_BHUTAN_MONK_DESCRIPTION_CHOICE_2',							'TXT_KEY_CITY_EVENT_JFD_BHUTAN_MONK_CHOICE_2_HELP'),
		('CITY_EVENT_JFD_DESERET_WAGON_TRAINS_CHOICE_1',					'AS2D_EVENT_CHOICE',			30,				0,				0,				0,			0,				0,						0,				'TXT_KEY_CITY_EVENT_JFD_DESERET_WAGON_TRAINS_DESCRIPTION_CHOICE_1',					'TXT_KEY_CITY_EVENT_JFD_DESERET_WAGON_TRAINS_CHOICE_1_HELP'),
		('CITY_EVENT_JFD_DESERET_WAGON_TRAINS_CHOICE_2',					'AS2D_EVENT_CHOICE',			30,				20,				0,				0,			0,				2,						0,				'TXT_KEY_CITY_EVENT_JFD_DESERET_WAGON_TRAINS_DESCRIPTION_CHOICE_2',					'TXT_KEY_CITY_EVENT_JFD_DESERET_WAGON_TRAINS_CHOICE_2_HELP'),
		('CITY_EVENT_JFD_DESERET_ZION_CHOICE_1',							'AS2D_EVENT_CHOICE',			30,				0,				0,				0,			0,				0,						0,				'TXT_KEY_CITY_EVENT_JFD_DESERET_ZION_DESCRIPTION_CHOICE_1',							'TXT_KEY_CITY_EVENT_JFD_DESERET_ZION_CHOICE_1_HELP'),
		('CITY_EVENT_JFD_DESERET_ZION_CHOICE_2',							'AS2D_EVENT_CHOICE',			30,				0,				0,				0,			0,				0,						0,				'TXT_KEY_CITY_EVENT_JFD_DESERET_ZION_DESCRIPTION_CHOICE_2',							'TXT_KEY_CITY_EVENT_JFD_DESERET_ZION_CHOICE_2_HELP'),
		('CITY_EVENT_JFD_ROME_CONSTANTINE_CIRCUS_MAXIMUS_CHOICE_1',			'AS2D_EVENT_CHOICE',			30,				0,				0,				0,			0,				0,						0,				'TXT_KEY_CITY_EVENT_JFD_ROME_CONSTANTINE_CIRCUS_MAXIMUS_DESCRIPTION_CHOICE_1',		'TXT_KEY_CITY_EVENT_JFD_ROME_CONSTANTINE_CIRCUS_MAXIMUS_CHOICE_1_HELP'),
		('CITY_EVENT_JFD_ROME_CONSTANTINE_CIRCUS_MAXIMUS_CHOICE_2',			'AS2D_EVENT_CHOICE',			30,				0,				0,				0,			2,				0,						0,				'TXT_KEY_CITY_EVENT_JFD_ROME_CONSTANTINE_CIRCUS_MAXIMUS_DESCRIPTION_CHOICE_2',		'TXT_KEY_CITY_EVENT_JFD_ROME_CONSTANTINE_CIRCUS_MAXIMUS_CHOICE_2_HELP'),
		('CITY_EVENT_JFD_ROME_CONSTANTINE_PAGAN_DISSENT_CHOICE_1',			'AS2D_EVENT_CHOICE',			30,				0,				0,				0,			0,				3,						0,				'TXT_KEY_CITY_EVENT_JFD_ROME_CONSTANTINE_PAGAN_DISSENT_DESCRIPTION_CHOICE_1',		'TXT_KEY_CITY_EVENT_JFD_ROME_CONSTANTINE_PAGAN_DISSENT_CHOICE_1_HELP');
--------------------------------------------------------------------------------------------------------------------------
...
VALUES	('CITY_EVENT_JFD_BHUTAN_MIGRANTS_CHOICE_1',							'FLAVOR_GROWTH',				20),
		...
		('CITY_EVENT_JFD_DESERET_WAGON_TRAINS_CHOICE_1',					'FLAVOR_GROWTH',				20),
		('CITY_EVENT_JFD_DESERET_WAGON_TRAINS_CHOICE_2',					'FLAVOR_DEFENSE',				20),
		('CITY_EVENT_JFD_DESERET_ZION_CHOICE_1',							'FLAVOR_GROWTH',				20),
		('CITY_EVENT_JFD_DESERET_ZION_CHOICE_2',							'FLAVOR_CULTURE',				20),
...
VALUES	('CITY_EVENT_JFD_BHUTAN_MIGRANTS_CHOICE_1',							'NOTIFICATION_EVENT_CHOICE_CITY_FIN',	'TXT_KEY_NOTIFICATION_CITY_EVENT_JFD_BHUTAN_MIGRANTS_CHOICE_1',						'TXT_KEY_CITY_EVENT_JFD_BHUTAN_MIGRANTS_DESCRIPTION',					1),
		...
		('CITY_EVENT_JFD_DESERET_ZION_CHOICE_1',							'NOTIFICATION_EVENT_CHOICE_CITY_FIN',	'TXT_KEY_NOTIFICATION_CITY_EVENT_JFD_DESERET_ZION_CHOICE_1',						'TXT_KEY_CITY_EVENT_JFD_DESERET_ZION_DESCRIPTION',						1),
		('CITY_EVENT_JFD_DESERET_ZION_CHOICE_2',							'NOTIFICATION_EVENT_CHOICE_CITY_FIN',	'TXT_KEY_NOTIFICATION_CITY_EVENT_JFD_DESERET_ZION_CHOICE_2',						'TXT_KEY_CITY_EVENT_JFD_DESERET_ZION_DESCRIPTION',						1),
...
VALUES	('CITY_EVENT_JFD_BHUTAN_MIGRANTS_CHOICE_1',							'TXT_KEY_WORLD_PLAYER_EVENT_JFD_BHUTAN_MIGRANTS_1'),
		('CITY_EVENT_JFD_BHUTAN_MIGRANTS_CHOICE_2',							'TXT_KEY_WORLD_PLAYER_EVENT_JFD_BHUTAN_MIGRANTS_2'),
		('CITY_EVENT_JFD_DESERET_ZION_CHOICE_1',							'TXT_KEY_WORLD_PLAYER_EVENT_JFD_DESERET_ZION_1');
--==========================================================================================================================
-- CIVILIZATIONS
--==========================================================================================================================
-- CityEvents
...
WHERE Type IN ('CITY_EVENT_JFD_BHUTAN_MIGRANTS', 'CITY_EVENT_JFD_BHUTAN_MONK')
AND EXISTS (SELECT Type FROM Civilizations WHERE Type = 'CIVILIZATION_JFD_BHUTAN');

--Deseret
UPDATE CityEvents
SET RequiredCiv = 'CIVILIZATION_JFD_DESERET', RandomChance = 20, EventClass = 'EVENT_CLASS_CIV_SPECIFIC'
WHERE Type IN ('CITY_EVENT_JFD_DESERET_WAGON_TRAINS', 'CITY_EVENT_JFD_BHUTAN_MONK')
AND EXISTS (SELECT Type FROM Civilizations WHERE Type = 'CIVILIZATION_JFD_DESERET');
...
WHEN NEW.Type IN ('CIVILIZATION_JFD_BHUTAN', 'CIVILIZATION_JFD_DESERET', 'CIVILIZATION_JFD_ROME_CONSTANTINE', 'CIVILIZATION_JFD_GE_UNITED_KINGDOM')
BEGIN
	--Bhutan
	UPDATE CityEvents
	SET RequiredCiv = 'CIVILIZATION_JFD_BHUTAN', RandomChance = 20, EventClass = 'EVENT_CLASS_CIV_SPECIFIC'

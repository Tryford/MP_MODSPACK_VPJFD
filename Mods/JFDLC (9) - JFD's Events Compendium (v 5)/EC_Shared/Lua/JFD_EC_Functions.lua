...
--JFD_EC_CityEventChoiceCanTake
function JFD_EC_CityEventChoiceCanTake(playerID, cityID, eventChoiceID)
	local player = Players[playerID]
	local eventChoice = GameInfo.CityEventChoices[eventChoiceID]
	--Resource Required
	for row in GameInfo.CityEventChoice_MinimumResourceRequired("CityEventChoiceType = '" .. eventChoice.Type .. "'") do
		if player:GetNumResourceAvailable(GameInfoTypes[row.ResourceType]) < row.Quantity then return false end
	end
	return true
end
GameEvents.CityEventChoiceCanTake.Add(JFD_EC_CityEventChoiceCanTake)
--=======================================================================================================================
--=======================================================================================================================
...
ALTER TABLE EventChoices      ADD ResistanceSentiment		integer  									default 0;
ALTER TABLE EventChoices      ADD ResetResistanceSentiment	boolean										default 0;
...
ALTER TABLE CityEventChoices  ADD ResistanceSentiment		integer  									default 0;
ALTER TABLE CityEventChoices  ADD ResetResistanceSentiment	boolean										default 0;

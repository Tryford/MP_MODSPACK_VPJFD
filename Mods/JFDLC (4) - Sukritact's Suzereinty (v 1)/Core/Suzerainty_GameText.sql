...
--==========================================================================================================================
  ...
  --------------------------------------------------------------------------
	...
	(
		...
		'Randomly receive a Great Writer, Artist or Musician every 60 turns. (On Standard).'
	),
  --------------------------------------------------------------------------
	(
  ...
  --------------------------------------------------------------------------
	...
	(
		...
		'+2 [ICON_CULTURE] Culture, +3 [ICON_GOLDEN_AGE] Golden Age Points from Writer, Artist and Musician Specialists.'
	),
  --------------------------------------------------------------------------
	(
  ...
  --------------------------------------------------------------------------
	...
	(
		...
		'+2 [ICON_HAPPINESS_1] Happiness from each type of Luxury resource you own.'
	),
  --------------------------------------------------------------------------
	(
  ...
  --------------------------------------------------------------------------
	...
	(
		...
		'+2 [ICON_FOOD] Food, +2 [ICON_GOLDEN_AGE] Golden Age Points from Wonders.'
	),
  --------------------------------------------------------------------------
	(
	...
	(
		...
		'+2 [ICON_FOOD] Food, +2 [ICON_PRODUCTION] Production from Artifacts and Great Works of Art. Recieve [ICON_GREAT_PEOPLE] Great Artist points when a city grows.'
	),
	(
  ...
  --------------------------------------------------------------------------
	...
	(
		...
		'May spend [ICON_PEACE] Faith at Göbekli Tepe to build a random Religious building in one of your Cities.'
	),
	(
	...
	(
		...
		'The workers of Göbekli Tepe have constructed a {1} in {2}!'
	),
  --------------------------------------------------------------------------
	(

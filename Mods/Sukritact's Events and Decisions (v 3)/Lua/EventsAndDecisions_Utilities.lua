...
g_TSLSave_Enabled			= g_TSLSave_Enabled > 0
--=======================================================================================================================
-- Utility Functions
--=======================================================================================================================
...
function HookDecisionCivilizationIcon(tTable, sCiv)
	if not(GameInfo.Civilizations[sCiv]) then return end
...
function HookDecisionReligionIcon(tTable, sReligion)
	if not(GameInfo.Religions[sReligion]) then return end

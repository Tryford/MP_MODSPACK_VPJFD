...
function OpenContractsOverview()
	LuaEvents.JFD_RTP_Mercenaries_ShowMercenaryOverview()
end
Controls.OpenContractsOverviewButton:RegisterCallback( Mouse.eLClick, OpenContractsOverview );
-------------------------------------------------
-------------------------------------------------
...
function UpdateDisplay()
    ...
    do
        ...
        if isMercenary then
			sortEntry.name = "[ICON_INVEST] " .. Locale.ConvertTextKey( unit:GetNameKey() );
        end

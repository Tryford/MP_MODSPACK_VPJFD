...
-----------------------------------------------------------------------------------------------------	
UPDATE GreatPersons
SET Specialist = 'SPECIALIST_JFD_MONK'
WHERE Type = 'GREATPERSON_PROPHET'
...
INSERT INTO UnitPromotions 
		(Type, 								GoldenAgeValueFromKills,	Description, 								Help, 												Sound, 				CannotBeChosen, LostWithUpgrade,	PortraitIndex,	IconAtlas, 			PediaType, 			PediaEntry)
VALUES	('PROMOTION_JFD_RELIGIOUS_UNIT', 	0,							'TXT_KEY_PROMOTION_JFD_RELIGIOUS_UNIT',		'TXT_KEY_PROMOTION_JFD_RELIGIOUS_UNIT_HELP', 		'AS2D_IF_LEVELUP', 	1, 				1, 					59, 			'ABILITY_ATLAS', 	'PEDIA_ATTRIBUTES', 'TXT_KEY_PROMOTION_JFD_RELIGIOUS_UNIT');

INSERT INTO UnitPromotions 
		(Type, 								GoldenAgeValueFromKills,	Description, 								Help, 												Sound, 				CannotBeChosen, LostWithUpgrade,	PortraitIndex, 	IconAtlas, 			PediaType, 			PediaEntry)
SELECT	'PROMOTION_JFD_TODAI',				50,							'TXT_KEY_PROMOTION_JFD_TODAI',				'TXT_KEY_PROMOTION_JFD_TODAI_HELP',					'AS2D_IF_LEVELUP', 	1, 				0, 					59, 			'PROMOTION_ATLAS', 	'PEDIA_ATTRIBUTES', 'TXT_KEY_PROMOTION_JFD_TODAI'

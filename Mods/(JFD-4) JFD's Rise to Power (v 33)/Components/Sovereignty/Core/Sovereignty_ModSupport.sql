...
UPDATE Buildings
SET SpecialistType = 'SPECIALIST_JFD_MONK'
WHERE Type = 'BUILDING_JFD_PYRAMID_MOON'
...
UPDATE JFD_Reforms
SET IsDisabled = 1
WHERE Type IN ('REFORM_JFD_SYSTEM_COMMON', 'REFORM_JFD_SYSTEM_CUSTOMARY', 'REFORM_JFD_SYSTEM_CIVIL', 'REFORM_JFD_PEERAGE_CEREMONIAL', 'REFORM_JFD_PEERAGE_PRIVILEGED', 'REFORM_JFD_PEERAGE_NONE', 'REFORM_JFD_BASIS_RELIGIOUS', 'REFORM_JFD_BASIS_MORAL', 'REFORM_JFD_BASIS_SECULAR', 'REFORM_JFD_MARRIAGE_CIVIC', 'REFORM_JFD_MARRIAGE_RELIGIOUS', 'REFORM_JFD_MARRIAGE_PRIVATE', 'REFORM_JFD_U_TAXATION_EXEMPT', 'REFORM_JFD_U_TAXATION_STANDARD', 'REFORM_JFD_U_TAXATION_HIGH', 'REFORM_JFD_CLAIMS_CAUSE', 'REFORM_JFD_CLAIMS_MIXED', 'REFORM_JFD_CLAIMS_INVESTMENT')
...
AND EXISTS (SELECT * FROM JFD_GlobalUserSettings WHERE Type = 'JFD_RTP_SOVEREIGNTY_ALT_FONTS_PARTIES' AND Value = 1);
...
FROM BuildingClasses WHERE Type IN ('BUILDINGCLASS_JFD_VERSAILLES')
...
FROM BuildingClasses WHERE Type IN ('BUILDINGCLASS_JFD_DOGES_PALACE')
AND EXISTS (SELECT * FROM JFD_GlobalUserSettings WHERE Type = 'JFD_CID_MISC_CITY_DISTRICTS' AND Value = 1);

INSERT INTO BuildingClass_JFD_District 
		(BuildingClassType, 	DistrictType)
SELECT	Type,					'BUILDINGCLASSCATEGORY_RELIGIOUS'
FROM BuildingClasses WHERE Type IN ('BUILDINGCLASS_JFD_ST_PETERS')
AND EXISTS (SELECT * FROM JFD_GlobalUserSettings WHERE Type = 'JFD_CID_MISC_CITY_DISTRICTS' AND Value = 1);
------------------------------------------------------------------------------------------------------------------------
-- JFD_Reforms
------------------------------------------------------------------------------------------------------------------------
